    ...
    return (
        <div name="skills" className="text-white w-full h-screen">
            <div className="max-w-[1000px] mt-[150px] sm:mt-auto mx-auto p-4 flex flex-col justify-center w-full h-full">
                <div>
                <img className="h-[90px] inline border-b-4 border-black mx-2" src="https://portfolio-site-assets-jg.s3.amazonaws.com/skills-text-nobg.png" alt="about" />
                    <p className="pt-4 pb-2 text-[22px]">These are the technologies I have worked with</p>
                </div>
