export default function Skills() {
    return (
        <div name="skills" className="text-white w-full h-screen sm:bg-cover" style={{ backgroundImage: "url('https://portfolio-site-assets-jg.s3.amazonaws.com/portfolio-stars.png')" }}>
