    ...
    return (
        <div name="hero" className="w-full h-screen">
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <h1 className="text-4xl sm:text-7xl font-bold text-white">Joe Graffeo</h1>
                <h2 className="text 3xl sm:text-6xl font-bold text-white">I am a full-stack Developer.</h2>
                <p className="text-white py-4 max-w-[700px]">I am a ful-stack developer specializing in front-end design. I have a passion for UX/UI and designing appealing and easy to use applications.</p>
                <div>
