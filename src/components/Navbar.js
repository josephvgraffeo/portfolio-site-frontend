...
export default function Navbar() {
    ...
    return (
        <div className="w-screen h-[75px] z-10 bg-[#0d0d0d] fixed drop-shadow-lg">
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className="flex items-center">
                    ...
                    <ul className="hidden md:flex">
                        ...
                        <Link to="skills" smooth={true} offset={-75} duration={500}><img className="rounded-lg w-[90px] ml-5 mr-8 cursor-pointer transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/skills-text-nobg.png" alt="skills" /></Link>
            ...
            <ul className={!nav ? "hidden" : "absolute bg-cover w-full px-8 flex flex-col justify-center items-center"} style={{ backgroundImage: "url('https://portfolio-site-assets-jg.s3.amazonaws.com/mobile-dropdown-bg.webp')" }}>
