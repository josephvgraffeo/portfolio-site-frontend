            ...
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className="flex items-center">
                    ...
                    <ul className="hidden md:flex">
                        <Link to="hero" smooth={true} duration={500}><img className="rounded-lg w-[90px] ml-8 cursor-pointer transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/skills-text-nobg.png" alt="home" /></Link>
                        ...
                        <Link to="skills" smooth={true} duration={500}><img className="rounded-lg w-[90px] ml-5 mr-8 cursor-pointer transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/skills-text-nobg.png" alt="skills" /></Link>
                        <Link to="projects" smooth={true} duration={500}><img className="rounded-lg w-[120px] ml-2 cursor-pointer transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/projects-text-nobg.png" alt="projects" /></Link>
                    </ul>
                </div>
                <div className="hidden md:flex pr-4">
                    <Link to="contact" smooth={true} duration={500}><img className="rounded-lg w-[150px] cursor-pointer transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/contact-text-nobg.png" alt="contact" /></Link>
                </div>
