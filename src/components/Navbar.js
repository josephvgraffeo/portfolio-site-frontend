    ...
    return (
        <div className="w-screen h-[80px] z-10 bg-[#0d0d0d] fixed drop-shadow-lg">
            ...
            <ul className={!nav ? "hidden" : "absolute bg-[#0d0d0d] w-full px-8 flex flex-col justify-center items-center"}>
                ...
                <Link to="projects" smooth={true} duration={500} onClick={handleClick}><img className="rounded-lg w-[170px] h-[70px] m-5 cursor-pointer transform transition-all duration-300 hover:scale-110 p-3 px-2" style={{ backgroundImage: "url('https://portfolio-site-assets-jg.s3.amazonaws.com/portfolio-button-bg-sm.webp')" }} src="https://portfolio-site-assets-jg.s3.amazonaws.com/projects-text-nobg.png" alt="projects" /></Link>
