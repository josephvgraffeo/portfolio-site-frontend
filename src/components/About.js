            ...
            <div className="flex flex-col justify-center items-center w-full h-full">
                <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8 text-white">
                    <div className="sm:text-right pb-8 pl-4">
                        <img className="w-[200px] sm:w-[250px] inline border-b-4 border-black mx-2 transform transition-all duration-300 hover:scale-110" src="https://portfolio-site-assets-jg.s3.amazonaws.com/about-text-nobg.png" alt="about" />
                    </div>
                    <div>
                        <div></div>
                    </div>
                ...
                <div className="max-w-[1000px] w-full sm:grid grid-cols-2 gap-8 text-white px-4">
                    <div className="sm:text-right text-4xl font-bold">
                        <img src="https://portfolio-site-assets-jg.s3.amazonaws.com/p5-portfolio-greeting.png" alt="greeting" className="w-[100%] h-[50%] mt-[-30px] transform transition-all duration-500 hover:scale-110 mb-[25px]" />
                    </div>
                    <div>
